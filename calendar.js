var cal = {
    // PROPERTIES
    mName: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], // Months
    ...
    list: function () {
        ...
        // REMOVE ANY PREVIOUS ADD/EDIT EVENT 
        cal.close();
    },

    // SHOW EDIT EVENT FOR SELECTED DAY
    show: function (el) {
        // FETCH EXISTING DATA
...
window.addEventListener("load", function () {
    ...
    // Set years range 2010-2031
    var year = document.getElementById("cal-yr");
    for (var i = nowYear - 11; i <= nowYear + 10; i++) {
        var opt = document.createElement("option");
        opt.value = i;
        opt.innerHTML = i;
